...
<head>
    ...
    @php
        ...
        $pageTitle = $seoMeta['title'] ?? $slotTitle ?? config('app.name', 'PT Lestari Jaya Bangsa');
        $ogTitle = $seoMeta['og_title'] ?? $slotTitle ?? config('app.name', 'PT Lestari Jaya Bangsa');
    @endphp
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function sendMessage() {
                ...
                const chatbotUrl = '/chatbot/message';
                fetch(chatbotUrl, {
                    method: 'POST',
                    headers: {
