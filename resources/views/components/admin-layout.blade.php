        ...
        <div class="bg-green-800 text-white w-64 py-6 px-4 fixed h-full overflow-y-auto">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('admin.users.index') }}"
                   class="sidebar-link block py-3 px-4 rounded-lg hover:bg-green-700 transition-colors {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 inline mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.roles.index') }}"
                   class="sidebar-link block py-3 px-4 rounded-lg hover:bg-green-700 transition-colors {{ request()->routeIs('admin.roles.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 inline mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.settings.index') }}"
                   class="sidebar-link block py-3 px-4 rounded-lg hover:bg-green-700 transition-colors {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 inline mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
