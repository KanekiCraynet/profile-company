    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-semibold text-gray-900">My Articles</h3>
                    <p class="text-2xl font-bold text-blue-600">{{ $stats['my_articles'] }}</p>
                    <p class="text-sm text-gray-500">{{ $stats['published_articles'] }} published, {{ $stats['draft_articles'] }} drafts</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-semibold text-gray-900">Today's Chats</h3>
                    <p class="text-2xl font-bold text-purple-600">{{ $stats['today_chats'] }}</p>
                    <p class="text-sm text-gray-500">{{ $stats['total_chats'] }} total sessions</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-green-600">{{ $stats['published_articles'] }}</p>
                ...
                @if($myRecentArticles->count() > 0)
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="font-medium text-gray-900">{{ Str::limit($article->title, 40) }}</p>
                ...
                @if($recentChats->count() > 0)
                    <div class="space-y-3 max-h-96 overflow-y-auto">
                        ...
                        <div class="border-l-4 border-green-500 pl-4 py-2">
                            <p class="text-sm font-medium text-gray-900">User: {{ Str::limit($chat->user_message, 50) }}</p>
                            <p class="text-sm text-gray-600 mt-1">Bot: {{ Str::limit($chat->bot_response, 60) }}</p>
