...
<head>
    ...
    <title>Admin Dashboard - PT Lestari Jaya Bangsa</title>
    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <h3 class="text-lg font-semibold mb-2">New Contacts</h3>
                    <p class="text-2xl font-bold text-green-600">0</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow">
                    <h3 class="text-lg font-semibold mb-2">Chat Sessions</h3>
                    <p class="text-2xl font-bold text-green-600">0</p>
                </div>
            </div>

            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="text-xl font-semibold mb-4">Welcome to Admin Dashboard</h3>
                <p class="text-gray-600">Manage your company website content from here.</p>
            </div>
        </div>
    </div>
</body>
